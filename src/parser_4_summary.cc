...
void Parser4Summary::ParseData(Block data)
{
 ...
 # if 0  
  ...
  QStringList line_data = data.at(line_no);
  ParseLine1_1(line_data);

  /* Line No. 3 */
  line_no++;
  line_data = data.at(line_no);
  ParseLine2_1(line_data);

  /* Line No. 4 */
  line_no++;
  line_data = data.at(line_no);
  ParseLine3_1(line_data);

  /* Line No. 5 */
  line_no++;
  line_data = data.at(line_no);
  ParseLine4_1(line_data);

  line_no = 10;
  line_data = data.at(line_no);
  ParseLine10_1(line_data);

  line_no++;
  line_data = data.at(line_no);
  ParseLine11_1(line_data);

  line_no++;
  line_data = data.at(line_no);
  ParseLine12_1(line_data);

  line_no++;
  line_data = data.at(line_no);
  ParseLine13_1(line_data);

  line_no++;
  line_data = data.at(line_no);
  ParseLine14_1(line_data);
}
...
void Parser4Summary::AddSummaryData(QString no, QString v_name, QString name,
...
void Parser4Summary::ParseLine15(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine16(QStringList data)
{
  //Read Position 2
  QString token = data.at(2);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine18(QStringList data)
{
  //Read Position 17
...
void Parser4Summary::ParseLine20(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
...
void Parser4Summary::ParseLine28(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine29(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine1_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);  
...
void Parser4Summary::ParseLine2_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine3_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine4_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine10_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine11_1(QStringList data)
{
  //Read Position 2
  QString token = data.at(2);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine12_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine13_1(QStringList data)
{
  //Read Position 0
  QString token = data.at(0);
  QString value = Utilities::ConvertEnglish(token);
...
void Parser4Summary::ParseLine14_1(QStringList data)
{
  //Read Position 2
  QString token = data.at(2);
  QString value = Utilities::ConvertEnglish(token);
